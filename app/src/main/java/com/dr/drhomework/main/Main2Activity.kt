...
//        (application as DrApplication).car.driving()
//
//        car = (application as DrApplication).car



        car.setClassName("메인2")
        car.driving()
...
//        binding.run{
//            lifecycleOwner = this@Main2Activity
//            mainActivity = this@Main2Activity
...
//        }
    ...
    private fun observerLiveData() {
        with(mainViewModel){
            contentListLiveData.observe(this@Main2Activity, Observer {
                dismissLoadingPopup()
                println(" contentListLiveData.observe  ${mainViewModel._stringTemp.value}")
            })

            _stringTemp.observe(this@Main2Activity, Observer {

                println(" contentListLiveData.observe 11  ${mainViewModel._stringTemp.value}")
            })

            callShowLoadingLiveData.observe(this@Main2Activity, Observer {
                showLoadingPopup()
            })
        }
    }
    ...
    private fun setRecyclerView() {
        ...
        binding.contentRv.layoutManager = LinearLayoutManager(this@Main2Activity)
